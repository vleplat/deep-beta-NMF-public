% Heuristic Simulated Annealing for Non-Negative Matrix Factorization
% 
% [W,H,e,e0] = heuristic_sa(X,r,options)
%
% Input.
...
function [W,H,e,e0] = heuristic_sa(X,r,options)
    [W,H,e0] = iteration_sa(X,r,options);
