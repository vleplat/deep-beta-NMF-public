...
% 
% It can replace beta(W) in the analysis of SNPA, and is smaller. It takes
% into account the order in which the columns of SNPA are extracted; 
% see Remark 1 in the paper 
% 'Successive ...'
%
